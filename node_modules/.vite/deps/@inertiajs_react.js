...
var globalFetchAPI = (({ fetch, Request: Request2, Response: Response2 }) => ({
  fetch,
  Request: Request2,
  Response: Response2
...
var factory = (env) => {
  const { fetch, Request: Request2, Response: Response2 } = Object.assign({}, globalFetchAPI, env);
  const isFetchSupported = isFunction3(fetch);
...
var getFetch = (config) => {
  ...
  const { fetch, Request: Request2, Response: Response2 } = env;
  const seeds = [
    Request2,
    Response2,
    fetch
